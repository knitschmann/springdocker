package net.beyondrealism.publictransport.processor;
...
import net.beyondrealism.publictransport.util.LineComparator;
import net.beyondrealism.publictransport.util.LineInformationComparator;
